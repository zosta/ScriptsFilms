...
namespace FilmApp.Model
{
    ...
    class Bibliotheque
    {
        ...
        public void creerDossierFilm()
        {
            log.Info("Création des dossier en cours...");
            ...
            foreach (DisqueDur dd in Configuration.Instance.disqueChoosen)
            {
                ...
                try
                {
                    ...
                    foreach (string repertoire in repertoires)
                    {
                        ...
                        if (dossierInfos.hasFilm)
                        {
                            Film film = new Film(dossierInfos.urlFilms);

                            var nom = film.urlFilm;
                            ...
                            string destinationFile = nom.Split('(')[0] + @"\" + nom.Replace(Configuration.Instance.emplacementFichierExportFilms, "");
